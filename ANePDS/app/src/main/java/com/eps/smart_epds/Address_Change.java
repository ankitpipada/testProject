...
public class Address_Change extends AppCompatActivity implements View.OnClickListener
{
    Toolbar toolbar;
    ActionBar actionBar;
    Bundle bundle;
    ...
    private void Init()
    {
        ...
        complete_surrender.setVisibility(View.GONE);
        partial_surrender.setVisibility(View.GONE);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(Address_Change.this,RationCardHolder.class);
        i.putExtra("value",1);
        startActivity(i);
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Intent i = new Intent(Address_Change.this,HomePage.class);
            startActivity(i);
            finish();
            return true;
        }
